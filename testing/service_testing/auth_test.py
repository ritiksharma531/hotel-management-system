...
class Testing(TestCase):
    ...
    def test_register_existing_user(self, mocked_DB):
        ...
        mocked_DB.return_value.get_item.return_value = (1, 'Ritik', '9876543210')
    ...
    def test_register_new_user(self, mocked_DB):
        auth_service = AuthService()
        mocked_DB.return_value.get_item.side_effect = [None, (2, 'Aman', '9998887776')]
    ...
    def test_login_wrong_password(self, mocked_DB):
        auth_service = AuthService()
        mocked_DB.return_value.get_item.side_effect = [(1, 'Ritik', '9876543210'), ('Asdf123456!', 'user')]
    ...
    def test_login_success(self, mocked_DB):
        auth_service = AuthService()
        mocked_DB.return_value.get_item.side_effect = [(1, 'Ritik', '9876543210'), ('Asdf123!', 'user')]
